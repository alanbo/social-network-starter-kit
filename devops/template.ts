import cloudform, { Fn, Refs, EC2, ECS, IAM, Logs } from "cloudform";
...
export default cloudform({
  ...
  Resources: {
    ...
    LogGroupMongo: new Logs.LogGroup({
      LogGroupName: 'vegewolf/social-api-mongo',
      RetentionInDays: 7
    }),
    ...
    StagingECSEC2Role: new IAM.Role({
      RoleName: 'social-api-staging7-ecs-ec2',
      AssumeRolePolicyDocument: {
        Version: '2012-10-17',
        Statement: [
          {
    ...
    StagingEC2Profile: new IAM.InstanceProfile({
      ...
      Roles: ['social-api-staging7-ecs-ec2']

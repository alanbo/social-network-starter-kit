...
export const gqlLikePost = gqlThunkCreator({
  mutation: gql_queries.LIKE_POST,
  type: gql_like_post
});

export const gqlUnlikePost = gqlThunkCreator({
  mutation: gql_queries.UNLIKE_POST,
  type: gql_unlike_post
});
